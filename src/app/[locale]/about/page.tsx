...
export default function About() {
  ...
  const skills = [
    ...
    { icon: Brain, label: "Learning", description: "AI Chatbot" },
    {
      icon: Coffee,
      label: "Soft Skills",
      description: t("about.skills.softSkills"),
    },
  ];
  const certificates = [
    {
      title: "Curso de Reparación de PC",
      issuer: "Programa de armado y reparacion de PC",
      year: "2025",
      img: "/certificates/Diploma-curso-reparacion-pc.png",
    },
    {
